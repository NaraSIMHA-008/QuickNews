            ...
            ModalDrawerSheet {
                Column(
                    ...
                    NavigationDrawerItem(
                        ...
                        onClick = {  urlHandler.openUri("https://www.linkedin.com/in/narasimha-reddy-327849264/") }
                    )
                    Divider()
                    NavigationDrawerItem(
                        ...
                        onClick = {   urlHandler.openUri("https://github.com/NaraSIMHA-008/InstantInfo") }
                    )
                    Divider()
                    NavigationDrawerItem(
                        ...
                        onClick = {   urlHandler.openUri("https://github.com/NaraSIMHA-008") }
                    )
                }
            }
        }
